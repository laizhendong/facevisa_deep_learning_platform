...
cfg = f.read()
# 用load方法转字典
label_dict = yaml.load(cfg, Loader=yaml.Loader)  
sets = label_dict['dataset']
classes = label_dict['class']
print(classes)
abs_path = os.getcwd()
...
parser.add_argument('--yolopath', dest='yolo_path',help='yolo dataset',default='/datasets/yolo_data/stain', type=str)
parser.add_argument('--vocpath', dest='voc_path',help='voc dataset',default='/datasets/voc_data/stain', type=str)
parser.add_argument('--classes', dest='classes',help='classes to train exclude bg',default=label_dict['class'], nargs='+',type=str)
