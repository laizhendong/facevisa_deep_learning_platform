数据目录结构
data/KPDTYSidebottomborderbrightBobbinOuterSilkOuter/train: image+pts
data/KPDTYSidebottomborderbrightBobbinOuterSilkOuter/test, image+pts

data目录中会生成其他目录和txt，后续运行时会用到

第一步: pts转成数据集  

```
python preprocess.py KPDTYSidebottomborderbrightBobbinOuterSilkOuter
```

第二步: 训练
```
python lib/train.py experiments\KPDTYSidebottomborderbrightBobbinOuterSilkOuter\pip_32_16_60_r18_l2_l1_10_1_nb10.py
```
配置文件中num_lms表示关键点个数
...
```
python lib/demo_dty.py experiments/KPDTYSidebottomborderbrightBobbinOuterSilkOuter/pip_32_16_60_r18_l2_l1_10_1_nb10.py data/KPDTYSidebottomborderbrightBobbinOuterSilkOuter/test
```
...
```
python lib/test.py experiments/KPDTYSidebottomborderbrightBobbinOuterSilkOuter/pip_32_16_60_r18_l2_l1_10_1_nb10.py test.txt test
```
